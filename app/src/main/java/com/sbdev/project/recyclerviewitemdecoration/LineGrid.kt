...
import com.sbdev.project.recyclerview_item_decoration.LineDecoration
...
import com.sbdev.project.recyclerviewitemdecoration.databinding.ActivityLineGridBinding

class LineGrid : AppCompatActivity() {

    private lateinit var binding: ActivityLineGridBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityLineGridBinding.inflate(layoutInflater)
        setContentView(binding.root)

        supportActionBar?.setDisplayHomeAsUpEnabled(true)

        val horizontalItemDecoration = LineDecoration(this).apply {
        ...
        val verticalItemDecoration = LineDecoration(this).apply {
