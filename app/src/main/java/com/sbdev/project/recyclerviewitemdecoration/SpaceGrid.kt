...
import com.sbdev.project.recyclerviewitemdecoration.databinding.ActivitySpaceGridBinding

class SpaceGrid : AppCompatActivity() {

    private lateinit var binding: ActivitySpaceGridBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySpaceGridBinding.inflate(layoutInflater)
